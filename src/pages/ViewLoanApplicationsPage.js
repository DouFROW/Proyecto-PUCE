...
const ViewLoanApplicationsPage = () => {
  ...
  const loanApplications = [
    ...
    },
    {
      ...
      gastos: "$900.00",
      capacidadPago: "$300.00",
      documentos: ["Cédula", "Comprobante de ingresos", "Certificado laboral", "Presupuesto de reparación"],
    ...
    },
    {
      ...
      documentos: ["Cédula", "Comprobante de ingresos", "Certificado laboral", "Presupuesto de mejoras"],
  ...
  const filteredApplications = loanApplications.filter(application => {
    const matchesSearch = application.socio.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const handleApprove = (applicationId) => {
    ...
    setSuccess({ show: true, message: 'Solicitud aprobada exitosamente', type: 'success' });
  ...
  return (
    <Box sx={{ p: 3 }}>
        ...
        <CardContent>
          <TableContainer component={Paper}>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell sx={{ fontWeight: 'bold' }}>ID Solicitud</TableCell>
                  ...
                  <TableRow key={index} hover>
                    ...
                    <TableCell>
                      <Stack direction="row" spacing={1}>
                        ...
                        {application.estado === 'Pendiente' || application.estado === 'En Revisión' ? (
                          <>
                            <IconButton
                              color="success"
      ...
      <Dialog open={applicationDetailsOpen} onClose={handleCloseDetails} maxWidth="md" fullWidth>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                ...
                <Typography variant="h6" color="primary" gutterBottom>
                  Socio: {selectedApplication.socio} ({selectedApplication.socioId})
                </Typography>
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                ...
                <Stack spacing={1}>
                  <Typography variant="body2">
                    <strong>Monto Solicitado:</strong> {selectedApplication.monto}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Plazo:</strong> {selectedApplication.plazo}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Fecha de Solicitud:</strong> {selectedApplication.fechaSolicitud}
                  </Typography>
                  <Typography variant="body2">
              ...
              <Grid item xs={12} md={6}>
                ...
                <Stack spacing={1}>
                  <Typography variant="body2">
                    <strong>Ingresos Mensuales:</strong> {selectedApplication.ingresos}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Gastos Mensuales:</strong> {selectedApplication.gastos}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Capacidad de Pago:</strong> {selectedApplication.capacidadPago}
                  </Typography>
                </Stack>
              </Grid>
