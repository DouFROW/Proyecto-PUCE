...
const AnnualDiscountReportPage = () => {
  ...
  const topMembers = [
    { socio: 'Juan Pérez', departamento: 'Administración', descuentos: 4200, prestamos: 2 },
    { socio: 'María González', departamento: 'Contabilidad', descuentos: 3800, prestamos: 1 },
    { socio: 'Carlos Mendoza', departamento: 'Sistemas', descuentos: 3600, prestamos: 1 },
    { socio: 'Ana Torres', departamento: 'Recursos Humanos', descuentos: 3400, prestamos: 1 },
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={monthlyDiscounts}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="descuentos" fill="#8884d8" name="Descuentos Totales" />
                  <Bar dataKey="prestamos" fill="#82ca9d" name="Descuentos Préstamos" />
                  <Bar dataKey="cuotas" fill="#ffc658" name="Cuotas Mensuales" />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={departmentDiscounts}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="descuentos" stroke="#8884d8" strokeWidth={2} name="Descuentos ($)" />
              <Line type="monotone" dataKey="socios" stroke="#82ca9d" strokeWidth={2} name="Número de Socios" />
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ fontWeight: 'bold' }}>Total Descuentos</TableCell>
                  <TableCell sx={{ fontWeight: 'bold' }}>Préstamos</TableCell>
                  <TableCell sx={{ fontWeight: 'bold' }}>Promedio Mensual</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Stack spacing={2}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', p: 1, backgroundColor: '#f5f5f5', borderRadius: 1 }}>
                  ...
                  <Typography variant="body2" fontWeight="bold">69</Typography>
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', p: 1, backgroundColor: '#f5f5f5', borderRadius: 1 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', p: 1, backgroundColor: '#e8f5e8', borderRadius: 1 }}>
                  <Typography variant="body2" fontWeight="bold">Total anual:</Typography>
                  <Typography variant="body2" fontWeight="bold" color="success.main">$22,190.40</Typography>
                </Box>
              </Stack>
            </Grid>
          </Grid>
